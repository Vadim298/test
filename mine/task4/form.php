...
<form action="task4.php" method="post">
    ...
    <label><input type="radio" name="oper" value="+" <?= getPost('oper') == '+' ? 'checked' : '' ?>> + </label>
    <label><input type="radio" name="oper" value="-" <?= getPost('oper') == '-' ? 'checked' : '' ?>> - </label>
    <label><input type="radio" name="oper" value="*" <?= getPost('oper') == '*' ? 'checked' : '' ?>> * </label>
    <label><input type="radio" name="oper" value="/" <?= getPost('oper') == '/' ? 'checked' : '' ?>> / </label><br>
    <label>число-операнд<input type="text" name="operand" value="<?= getPost('operand') ?>"></label><br>
